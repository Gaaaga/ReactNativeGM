...
class Dialog extends React.Component {
    ...
    return this.props.buttons.map((button, i) => {
      ...
      return (
        ...
        >
          <Text
            style={[
              styles.dialogFooterOprText,
              styles[`${type}DialogFooterOprText`]
            ]}
          >
            {label}
          </Text>
  ...
  render() {
    const { title, visible, onClose, style, children } = this.props;
        ...
        <View style={[styles.dialogWrapper, style]}>
          <TouchableWithoutFeedback onPress={null}>
            <View style={styles.dialog}>
              ...
              <View style={styles.dialogFooter}>{this.renderButtons()}</View>
            </View>
          </TouchableWithoutFeedback>
        </View>
      </TouchableWithoutFeedback>
