    ...
    return (
      ...
      >
        <View>
          ...
          {redCount ? (
            <View
              style={[S.flexJustifyCenter, S.flexAlignCenter, styles.redPoint]}
            >
              <Text style={styles.redCount}>
                {redCount > 99 ? "..." : redCount}
              </Text>
            </View>
          ) : null}
        </View>
...
class Tabs extends React.Component {
  render() {
    ...
    return <View style={[S.flexRow, S.borderBottom, S.bgWhite]}>{items}</View>;
  }
}
