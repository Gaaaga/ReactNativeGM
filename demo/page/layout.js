...
import { Square, Page, Header, Styles as S } from "../../src/index";
        ...
        <View style={[S.flex, S.flexRow, S.flexAlignStart]}>
          {_.map(this.state.arr, (value, i) => (
            <Square
              component={<View />}
              key={i}
              style={[S.flex, { backgroundColor: value }, S.margin10]}
            >
              <Image
                source={{
                  uri:
                    "https://ss0.baidu.com/6ONWsjip0QIZ8tyhnq/it/u=1796995164,3252526142&fm=80"
                }}
              />
            </Square>
          ))}
